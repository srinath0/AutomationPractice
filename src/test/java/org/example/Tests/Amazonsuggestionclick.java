...
public class Amazonsuggestionclick {
    ...
    public void phoneClick() {
        ...
        try {
            ...
            Utils.getWait(driver, 5).until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath("//div[contains(@class,'s-suggestion-container')]")));
            List<WebElement> suggestions = driver.findElements(By.xpath("//div[contains(@class,'s-suggestion-container')]"));
            ...
            Utils.getWait(driver, 10).until(ExpectedConditions.titleContains("Results"));
